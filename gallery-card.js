          ...
          <div class="card-header-actions">
            ${this.config.enable_date_search?Y`
                  <div class="date-filter-container">
                    ...
                    ${this._isDateFiltered?Y`<span class="action-text btn-clear-date" @click="${this._clearDateFilter}">清除筛选</span>`:Y``}
                  </div>
                `:Y``}
            ${this.config.show_reload?Y`<span class="action-text btn-reload" @click="${()=>this._loadResources(this._hass)}">刷新列表</span>`:Y``}
          </div>
